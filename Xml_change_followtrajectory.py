...
import sys
sys.path.append("C:/IPG/carmaker/win64-12.0.1/Python/python3.9")
import cmapi
import pathlib
def tra(file_name):
    ...
    # 构建文件路径
    old_file_path = r"C:\IPG\RoadRunner R2022b\Test\Exports\\" + xosc_name
    file_path = r"C:\CM_Projects\PROJECTNAME\Data_osc\\" + xosc_name
    new_file_path = r"C:\CM_Projects\PROJECTNAME\Data_osc\\" + xosc_name
    Trajectory_file = r"C:\CM_Projects\PROJECTNAME\Data_osc\Catalogs\Trajectory\\"+xosc_name
...
#添加头文件描述，这样vscode就可以识别出是xml代码
    ...
    cmd_command = 'C:\\CM_Projects\\PROJECTNAME\\bin\\osc2cm.win64.exe --cmprojpath ../ --oscfname Data_osc/{} --validate --egoname Ego --trfname {} --rdfname {}_road --egoinf DemoCar --trfendmode 2 --loglevel 4 --logtofile --logtoconsole --trfmobj --defaultman 1.0 '.format(xosc_name,file_name,file_name)
    try:
